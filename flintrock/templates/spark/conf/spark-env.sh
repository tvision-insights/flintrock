...
# TODO: this should possibly only be done for "without-hadoop" distributions?
export SPARK_DIST_CLASSPATH="$($HOME/hadoop/bin/hadoop --config $HADOOP_CONF_DIR classpath)"
